...
function Navbar() {
  ...
  function goToGithubLogin() {
    window.location.href = import.meta.env.VITE_API_URL + "/gitpulse/auth/github";
  }

  function goToGoogleLogin() {
    window.location.href = import.meta.env.VITE_API_URL + "/gitpulse/auth/google";
  }
      ...
      <div className="collapse navbar-collapse" id="navbarContent">
        {user ? (
          <div className="ms-auto d-flex align-items-center gap-2 mt-2 mt-md-0">
            <button
              onClick={function () { navigate("/favourites"); }}
          ...
          <div className="ms-auto d-flex flex-wrap align-items-center gap-2 mt-2 mt-md-0">
            <button
